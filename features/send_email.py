...
class Feature(BaseFeature):
    ...
    def action(self, spoken_text):
        ...
        try:
            ...
            self.bs.respond("I will cease trying to send an email now.")
            return
        # get subject
        self.bs.respond('What is the subject of your email?')
        subject = ''
        subject = self.bs.infinite_speaking_chances(subject)
        if self.bs.interrupt_check(subject):
            return
        # get message
        self.bs.respond('What is the message of your email?')
        message = ''
        message = self.bs.infinite_speaking_chances(message)
